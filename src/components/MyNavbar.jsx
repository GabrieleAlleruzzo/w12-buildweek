    ...
    >
      <Container fluid className="align-items-center justify-content-start">
        ...
        <div className="d-flex align-items-center me-5">
          ...
          {/* Barra di ricerca */}
          <Form
            className="d-none d-md-flex flex-grow-0"
            style={{ width: "250px" }}
          >
            <Form.Control
              type="search"
        ...
        <Nav className="d-flex flex-row align-items-center ms-auto">
          ...
          <Nav.Link
            href="#"
            className="d-flex flex-column align-items-center me-4 text-center"
          >
          ...
          >
            ...
            <NavDropdown.Item href="#">
              <i class="bi bi-person-plus-fill"></i>Pubblica un'offerta di
              Lavoro
            </NavDropdown.Item>
            <NavDropdown.Divider />
            <NavDropdown.Item href="#">
              <i class="bi bi-info-square-fill"></i>Trova i migliori Freelancer
            </NavDropdown.Item>
            <NavDropdown.Item href="#">
          ...
          <Nav.Link
            href="#"
            className="d-flex flex-column align-items-center ms-4 me-4 text-center"
          >
            <i
          ...
          <Nav.Link
            href="#"
            className="d-flex flex-column align-items-center text-warning ms-2"
          >
